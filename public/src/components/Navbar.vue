<template>
  <nav class="navbar navbar-expand-lg navbar-dark bg-dark rounded">
    ...
    <li class="nav-item">
        ...
        <li v-if="auth==''" class="nav-item">
          <router-link class="nav-item btn btn-xs btn-outline-secondary mt-1 ml-3" to="/register">Register</router-link>
        </li>
        <li v-if="auth=='loggedin'" class="nav-item">
          <router-link class="btn btn-xs btn-outline-secondary mt-1 nav-item ml-3" to="/profile">Profile</router-link>
        </li>
          <li v-if="auth=='loggedin'" class="nav-item">
          <router-link class="nav-item btn btn-xs btn-outline-secondary mt-1 ml-3" to="/create">Create Post</router-link>
        </li>
        <li v-if="auth=='loggedin'" class="nav-item">
          <a class="nav-item btn btn-xs btn-outline-secondary mt-1 ml-3s" href="" v-on:click="logout">Log out</a>
        </li>
           <li v-if="auth=='loggedin'" class="nav-item">
